		...
		switch ( $type ) {
			case 'small':
				...
				<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank" style="display:inline-block;">
					...
					">
					<input type="submit" name="submit" class="button" value="<?php esc_attr_e( 'Donate via paypal', 'author-avatars' ); ?>" title="<?php esc_attr_e( 'PayPal - The safer, easier way to pay online!', 'author-avatars' ); ?>">
				</form>
				<a href="https://buymeacoffee.com/pbearne" class="button" target="_blank" title="<?php esc_attr_e( 'Buy Me a Coffee', 'author-avatars' ); ?>">
					<span class="dashicons dashicons-coffee"></span> <?php esc_html_e( 'Buy Me a Coffee', 'author-avatars' ); ?>
				</a>
				<?php
				break;
			case 'large':
				...
				<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank" style="display:inline-block;">
					...
					">
					<input type="submit" name="submit" class="button button-primary" value="<?php esc_attr_e( 'Donate via paypal', 'author-avatars' ); ?>" title="<?php esc_attr_e( 'PayPal - The safer, easier way to pay online!', 'author-avatars' ); ?>">
				</form>
				<a href="https://buymeacoffee.com/pbearne" class="button button-primary" target="_blank" title="<?php esc_attr_e( 'Buy Me a Coffee', 'author-avatars' ); ?>">
					<span class="dashicons dashicons-coffee"></span> <?php esc_html_e( 'Buy Me a Coffee', 'author-avatars' ); ?>
				</a>
				<?php
				break;
